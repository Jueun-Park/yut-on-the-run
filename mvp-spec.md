...
## 5A. 던지기 결과 확률(MVP 근사 테이블)

### Option B: 균형잡힌 확률 분포
아래는 전통 윷놀이 느낌을 반영한 MVP용 근사 확률표입니다.
개/걸이 가장 흔하게 나오고, 도는 상대적으로 덜 나오며, 윷/모는 희귀하게 설정되었습니다.
...
> **참고**: 이 확률표는 MVP를 위한 간단한 근사치이며, 향후 물리 기반 시뮬레이션이나 실제 윷가락 데이터로 교체할 수 있습니다.
